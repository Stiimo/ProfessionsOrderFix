...
function ProfessionsOrderFix_ProfessionsCraftingOrderPageMixin:InitOrderTypeTabs()
...
function ProfessionsOrderFix_ProfessionsCraftingOrderPageMixin:InitRecipeList()
...
function ProfessionsOrderFix_ProfessionsCraftingOrderPageMixin:SetBrowseType(browseType)
...
function ProfessionsOrderFix_ProfessionsCraftingOrderPageMixin:GetBrowseType()
	return self.browseType;
end

function ProfessionsOrderFix_ProfessionsCraftingOrderPageMixin:SortOrderIsValid(sortOrder)
...
function ProfessionsOrderFix_ProfessionsCraftingOrderPageMixin:ResetSortOrder()
	self.primarySort =
	{
...
function ProfessionsOrderFix_ProfessionsCraftingOrderPageMixin:SetSortOrder(sortOrder)
...
function ProfessionsOrderFix_ProfessionsCraftingOrderPageMixin:GetSortOrder()
	return self.primarySort.order, self.primarySort.ascending;
end

function ProfessionsOrderFix_ProfessionsCraftingOrderPageMixin:SetupTable()
	local browseType = self:GetBrowseType();
...
function ProfessionsOrderFix_ProfessionsCraftingOrderPageMixin:InitOrderList()
	local pad = 5;
	local spacing = 1;
...
function ProfessionsOrderFix_ProfessionsCraftingOrderPageMixin:OnEvent(event, ...)
...
function ProfessionsOrderFix_ProfessionsCraftingOrderPageMixin:OnLoad()
	self:InitButtons();
	self:InitOrderTypeTabs();
	self:InitRecipeList();
...
function ProfessionsOrderFix_ProfessionsCraftingOrderPageMixin:StartDefaultSearch()
	if self.lastRequest then
		self:SendOrderRequest(self.lastRequest);
...
function ProfessionsOrderFix_ProfessionsCraftingOrderPageMixin:OnShow()
...
function ProfessionsOrderFix_ProfessionsCraftingOrderPageMixin:OnHide()
...
function ProfessionsOrderFix_ProfessionsCraftingOrderPageMixin:GetDesiredPageWidth()
	return 1105;
end

function ProfessionsOrderFix_ProfessionsCraftingOrderPageMixin:GetProfessionFrame()
	return self:GetParent();
end

function ProfessionsOrderFix_ProfessionsCraftingOrderPageMixin:Refresh(professionInfo)
...
function ProfessionsOrderFix_ProfessionsCraftingOrderPageMixin:SetTitle()
...
function ProfessionsOrderFix_ProfessionsCraftingOrderPageMixin:UpdateFavoritesButton()
...
function ProfessionsOrderFix_ProfessionsCraftingOrderPageMixin:OnRecipeSelected(recipeInfo, recipeList)
...
function ProfessionsOrderFix_ProfessionsCraftingOrderPageMixin:CheckForClaimedOrder()
...
function ProfessionsOrderFix_ProfessionsCraftingOrderPageMixin:ClearCachedRequests()
	self.selectedRecipe = nil;
	self.lastBucketRequest = nil;
	self.lastRequest = nil;
end

function ProfessionsOrderFix_ProfessionsCraftingOrderPageMixin:Init(professionInfo)
...
function ProfessionsOrderFix_ProfessionsCraftingOrderPageMixin:SelectRecipeFromBucket(buckectInfo)
...
function ProfessionsOrderFix_ProfessionsCraftingOrderPageMixin:SetCraftingOrderType(orderType)
...
function ProfessionsOrderFix_ProfessionsCraftingOrderPageMixin:SendOrderRequest(request)
...
function ProfessionsOrderFix_ProfessionsCraftingOrderPageMixin:RequestOrders(selectedSkillLineAbility, searchFavorites, initialNonPublicSearch)
	if (self.professionInfo == nil) then
		return;
	end
	local request =
	{
...
function ProfessionsOrderFix_ProfessionsCraftingOrderPageMixin:RequestMoreOrders()
...
function ProfessionsOrderFix_ProfessionsCraftingOrderPageMixin:ShowBuckets(offset, isSorted)
	self.BrowseFrame.BackButton:Hide();
	self:ShowGeneric(C_CraftingOrders.GetCrafterBuckets(), OrderBrowseType.Bucketed, offset, isSorted);
end

function ProfessionsOrderFix_ProfessionsCraftingOrderPageMixin:ShowOrders(offset, isSorted)
...
function ProfessionsOrderFix_ProfessionsCraftingOrderPageMixin:OrderRequestCallback(result, orderType, displayBuckets, expectMoreRows, offset, isSorted)
...
function ProfessionsOrderFix_ProfessionsCraftingOrderPageMixin:ViewOrder(orderInfo)
...
function ProfessionsOrderFix_ProfessionsCraftingOrderPageMixin:CloseOrder()
